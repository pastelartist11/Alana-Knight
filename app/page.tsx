export default function Page() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#0b3cff] text-white">
      ...
      <div className="pointer-events-none hidden sm:block absolute left-10 top-16 h-24 w-24 rounded-full bg-[#ffdd55]/60 blur-2xl" />
      <div className="pointer-events-none hidden sm:block absolute right-16 top-28 h-24 w-24 rounded-full border border-[#ff5ebc]/50 bg-[#ff5ebc]/20 rotate-12" />

      <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl flex-col gap-10 px-4 py-8 sm:px-10">
        <div className="grid gap-8 lg:grid-cols-[1.6fr_0.9fr]">
          <div className="rounded-[2rem] border-4 border-black bg-[#efece8] shadow-[14px_14px_0_rgba(0,0,0,0.9)]">
            <div className="flex flex-col gap-4 rounded-t-[1.5rem] border-b-4 border-black bg-[#ff3cac] px-5 py-4 text-sm uppercase tracking-[0.35em] text-white sm:flex-row sm:items-center sm:justify-between">
              <span>ALANA.KNIGHT</span>
              <span className="h-6 w-6 rounded-sm border-2 border-white/90 bg-[#ffe4ef]" />
            </div>
            <div className="relative grid gap-6 p-5 lg:grid-cols-[1fr_0.9fr] lg:p-6">
              <div className="space-y-4">
                ...
                <div className="grid gap-3 sm:grid-cols-3">
                  <button className="rounded-[1rem] border-4 border-black bg-[#ff3cac] px-4 py-4 text-sm font-black uppercase tracking-[0.35em] text-white shadow-[6px_6px_0_rgba(0,0,0,0.18)]">
                    Home
                  </button>
                  <button className="rounded-[1rem] border-4 border-black bg-[#ffdd55] px-4 py-4 text-sm font-black uppercase tracking-[0.35em] text-[#1d1d1d] shadow-[6px_6px_0_rgba(0,0,0,0.18)]">
                    Projects
                  </button>
                  <button className="rounded-[1rem] border-4 border-black bg-[#3d8cff] px-4 py-4 text-sm font-black uppercase tracking-[0.35em] text-white shadow-[6px_6px_0_rgba(0,0,0,0.18)]">
                    Contact
                  </button>
                </div>
              </div>
